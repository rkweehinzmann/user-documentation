...
To access the filters you must use the table menu in the top right corner of the tables header ![see image](./img/open_menu.png)
...
### Filtering columns
You can use the column settings option which will enable you to see a list of the available columns and checkbox each one you wish to be part of your view. ![see image](./img/column_settings.png)\
...
![see image](./img/selected_columns.png)\
Once you've selected all of the columns, apply the changes by clicking on the tick in the bottom right corner ![see image](./img/tick_to_apply_filters.png)\
Now that you've applied the changes to your settings, your table will reflect only the columns you selected.
![see image](./img/applied_filters_on_table.png)
...
![see image](./img/drag_option_before.png) ![see image](./img/drag_option_after.png)\
...
![see image](./img/save_table_settings.png)\
...
![see image](./img/save_data_selection.png)\
...
#### Saving to JSON
![see image](./img/save_as_json.png)\
...
In SciCat there is also the ability to only save data for manually selected data. ![see image](./img/selecting_specific_records_to_save_to_file.png)\
